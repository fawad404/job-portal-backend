...
app.use(cors( {
origin: ["https://job-portal-fawad-application.vercel.app"],
  methods: ["POST", "GET"],
  credentials: true
}
));
...
const uri = `mongodb+srv://lakshay22dhoundiyal:u97klyTxI0FAnbnn@job-portal.7ieojkl.mongodb.net/?retryWrites=true&w=majority&appName=job-portal`;
